    ...
    <div id="posts" class="post">
			...
			<div class="description">
				<p class="p_text">
					...
					Até 05 de julho de 2013 - Submissão dos Resumos.
				</p>
				<p class="p_text">
					<br /> <input type="image" class="image_p" src="images/next.png" />&nbsp;
					Até 15 de julho de 2013 - Submissão dos Resumos com pendência, já
					com os ajustes indicados pela Comissão Científica.
				</p>
			</div>
