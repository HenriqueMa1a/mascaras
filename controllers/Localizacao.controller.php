<?php
if(!class_exists('LocalizacaoDAO')){ require_once 'models/LocalizacaoDAO.class.php';}
/**
 *  Controle responsável pela módulo Localizacao. 
 * 
 * @package Controller
 * @category Controller
 * @version 1.0
...
class LocalizacaoController extends Controller{
     ...
     *
     * @return object Objeto do tipo Localizacao
     */    
