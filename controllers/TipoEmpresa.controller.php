<?php
if(!class_exists('TipoEmpresaDAO')){ require_once 'models/TipoEmpresaDAO.class.php';}
/**
 *  Controle responsável pela módulo TipoEmpresa. 
 * 
 * @package Controller
 * @category Controller
 * @version 1.0
...
class TipoEmpresaController extends Controller{
    ...
    public function __construct(){
        parent::__construct('cadastro-tipo-empresa');
    }
    
    /**
     *  Método para retornar um registro
     *
     * @return object Objeto do tipo TipoEmpresa
     */    
