...
class EstadoController extends Controller{
     ...
     *
     * @return object Objeto do tipo Estado
     */    
        ...
        try{
            ...
            if ($Id){
                ...
                if ($obj){
                    ...
                    $this->response->IdRegiao = $obj->getIdRegiao();
                    $this->response->NomeRegiao = $obj->getNomeRegiao();
    ...
    public function listar() {
        ...
        try {
            ...
            $IdRegiao = self::getVar('IdRegiao');
            $Nome = self::getVar('Nome');

            $DAO = new EstadoDAO();
            $listagem = $DAO->listar(null, null, 'nome', 'asc', $IdPais, $IdRegiao, $Nome);
            if ($listagem) {
    ...
    public function listarCombo() {
        try {
            ...
            $DAO = new EstadoDAO();
            $listagem = $DAO->listar(null, null, 'nome', 'asc', $IdPais, $IdRegiao);
            if ($listagem) {
