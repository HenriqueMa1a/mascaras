    ...
    switch($acao) {
        case("visualizar"):     
            ...
            try{
                ...
                if ($Chave){
					$daoResumoChave = new ResumoDAO();
					$objResumoChave = $daoResumoChave->retornarPorChave($Chave);
                    ...
                    if ($objResumoChave){											
						...
						if($objResumo){ 
							...
							*/
							...
							$pdf->AddPage('L');
							// set the source file
							$pdf->setSourceFile("templates//layout_certificado_poster_2019.pdf");
							// import page 1
							...
							$texto1 = 'submitted by the authors:';
							$texto2 = 'has been presented in the IV International Symposium on Immunobiologicals '; 
							$texto2 .='organized by the Institute of Technology in Immunobiologicals (Bio-Manguinhos/Fiocruz) ';
							$texto2 .='on May 7th, 8th and 9th, 2019, in Rio de Janeiro, Brazil.';
