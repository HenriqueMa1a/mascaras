                    ...
                    if ($objResumoChave){
						...
						if($objResumo){ 
							...
							*/
							...
							$texto1 = 'Certificamos que o trabalho de título';
							$texto2 = 'submetido para participação no evento em nome dos autores';
