            ...
            try{
                ...
                if ($Chave){
                    ...
                    if ($objEventoPresenca){
                        ...
                        //$pdf->AddFont('TwCenMT','CB','TCCB____.php');
						//$pdf->AddFont('TwCenMT','CEB','TCCEB.php');
						//$pdf->AddFont('TwCenMT','C','TCCM____.php'); 						 
						...
						$texto2 = 'participou do VI Seminário Anual Científico e Tecnológico de Bio-Manguinhos, que aconteceu de 8 a 10 de maio de 2018, com carga horária de 21 horas, organizado pelo Instituto de Tecnologia em Imunobiológicos (Bio-Manguinhos/Fiocruz).';
