                                        ...
                                        <div class="panel-body">
                                            <form id="formCadastro" name="formCadastro" action="action.php" method="post" onsubmit="return false;" >
                                                ...
                                                <div class="row clearfix">
                                                    ...
                                                    <div class="form-group-sm required col-xs-6 col-sm-6 col-md-3 col-lg-3"  id="boxIdRegiao">
                                                        <label class="control-label label-sm" for="IdRegiao">Região:</label>
                                                        <select class="form-control input-sm" id="IdRegiao" name="IdRegiao" onchange="" >
                                                                <option value="">[Nenhum]</option>
                                                        </select>
                                                    </div>
                                                </div>
                                                <div class="row clearfix">
                                                    ...
                                                    <div class="form-group-sm required col-xs-12 col-sm-12 col-md-6 col-lg-6" >
