 ...
 */
class Email {  
    private static $Mailer = 'smtp';
    private static $SMTPDebug = 1;	
    private static $SMTPHost = 'correio.bio.fiocruz.br';
    private static $SMTPPort = '25'; // {25, ssl:465, tsl:587}
    private static $SMTPAuth = '';
    private static $SMTPAutoTLS = '';
    private static $SMTPOptions = '';	
    private static $SMTPSecure = ''; // {'', ssl, tsl}
    private static $Email = 'sact@bio.fiocruz.br';
    private static $EmailNome = 'V Seminário Anual Científico e Tecnológico de Bio-Manguinhos';
    private static $EmailUsuario = 'sact';// = 'sact';
