...
class Estado extends Modelo{
    ...
    public function setIdRegiao( $p_IdRegiao ){ $this->_IdRegiao = $p_IdRegiao; }
    public function getIdRegiao(){ return $this->_IdRegiao; }

    public function setNomeRegiao( $p_NomeRegiao ){ $this->_NomeRegiao = $p_NomeRegiao; }
    public function getNomeRegiao(){ return $this->_NomeRegiao; }
